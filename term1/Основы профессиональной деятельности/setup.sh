...
mkdir donphan3
mkdir donphan3/cleffa
mkdir donphan3/bellossom
#touch donphan3/{gurdurr,mienfoo,drifblim}
touch donphan3/gurdurr
touch donphan3/mienfoo
touch donphan3/drifblim

#mkdir -p krokorok4/{tentacruel,whismur}
mkdir krokorok4
mkdir krokorok4/tentacruel
mkdir krokorok4/whismur
...
mkdir sudowoodo1
mkdir sudowoodo1/hitmontop
mkdir sudowoodo1/sceptile
...
ls -lR 2>/dev/null | grep "m$" | sort -rk9
cat -n donphan3/gurdurr donphan3/mienfoo donphan3/drifblim | sort
ls -lR 2>/tmp/error.log | grep "ro" | sort -rk9 | tail -n 3
wc -l m* */m* */*/m* 2>/dev/null | sort
grep -rl "mi" 2>/dev/null | sort -nk2
